...
_PAYMENTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="token_id",
            full_name="printable.PaymentRequest.token_id",
            index=3,
            number=4,
            type=4,
            cpp_type=4,
...
_TXOUTGIFTCODE = _descriptor.Descriptor(
    name="TxOutGiftCode",
    full_name="printable.TxOutGiftCode",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="global_index",
            full_name="printable.TxOutGiftCode.global_index",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="printable.TxOutGiftCode.onetime_private_key",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="shared_secret",
            full_name="printable.TxOutGiftCode.shared_secret",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PRINTABLEWRAPPER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="tx_out_gift_code",
            full_name="printable.PrintableWrapper.tx_out_gift_code",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_PAYMENTREQUEST.fields_by_name["public_address"].message_type = (
    external__pb2._PUBLICADDRESS
)
_TRANSFERPAYLOAD.fields_by_name["tx_out_public_key"].message_type = (
    external__pb2._COMPRESSEDRISTRETTO
)
_TXOUTGIFTCODE.fields_by_name["onetime_private_key"].message_type = (
    external__pb2._RISTRETTOPRIVATE
)
_TXOUTGIFTCODE.fields_by_name["shared_secret"].message_type = (
    external__pb2._COMPRESSEDRISTRETTO
)
_PRINTABLEWRAPPER.fields_by_name["public_address"].message_type = (
    external__pb2._PUBLICADDRESS
)
...
_PRINTABLEWRAPPER.fields_by_name["tx_out_gift_code"].message_type = _TXOUTGIFTCODE
_PRINTABLEWRAPPER.oneofs_by_name["wrapper"].fields.append(
    _PRINTABLEWRAPPER.fields_by_name["public_address"]
)
_PRINTABLEWRAPPER.fields_by_name["public_address"].containing_oneof = (
    _PRINTABLEWRAPPER.oneofs_by_name["wrapper"]
)
_PRINTABLEWRAPPER.oneofs_by_name["wrapper"].fields.append(
    _PRINTABLEWRAPPER.fields_by_name["payment_request"]
)
_PRINTABLEWRAPPER.fields_by_name["payment_request"].containing_oneof = (
    _PRINTABLEWRAPPER.oneofs_by_name["wrapper"]
)
_PRINTABLEWRAPPER.oneofs_by_name["wrapper"].fields.append(
    _PRINTABLEWRAPPER.fields_by_name["transfer_payload"]
)
_PRINTABLEWRAPPER.fields_by_name["transfer_payload"].containing_oneof = (
    _PRINTABLEWRAPPER.oneofs_by_name["wrapper"]
)
_PRINTABLEWRAPPER.oneofs_by_name["wrapper"].fields.append(
    _PRINTABLEWRAPPER.fields_by_name["tx_out_gift_code"]
)
_PRINTABLEWRAPPER.fields_by_name["tx_out_gift_code"].containing_oneof = (
    _PRINTABLEWRAPPER.oneofs_by_name["wrapper"]
)
...
DESCRIPTOR.message_types_by_name["TxOutGiftCode"] = _TXOUTGIFTCODE
...
TxOutGiftCode = _reflection.GeneratedProtocolMessageType(
    "TxOutGiftCode",
    (_message.Message,),
    {
        "DESCRIPTOR": _TXOUTGIFTCODE,
        "__module__": "printable_pb2",
        # @@protoc_insertion_point(class_scope:printable.TxOutGiftCode)
    },
)
_sym_db.RegisterMessage(TxOutGiftCode)
